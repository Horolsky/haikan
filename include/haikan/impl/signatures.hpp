...
struct SignatureBase : public Expression
{
    ...
    operator boost::json::value() const // allowing implicit conversion
    {
...
struct SignatureBinary : public SignatureBase<K>
{
    ...
    {
        return Expression(Expression::encodeNested(K, {handle_list_init(param)}));
    }
};
...
struct SignatureBinary<Keyword::PreProc> : public SignatureBase<Keyword::PreProc>
{
    ...
    {
        return Expression(Expression::encodePreProc((boost::format("$[%s]") % param).str().c_str()));
    }
...
{
  private:
    static Expression encodeVariadic(std::initializer_list<Expression> params)
    {
...
struct SignatureErr : public SignatureBase<Keyword::Err>
{
    ...
    Expression operator()(type_tag<T>, boost::json::string msg = "", boost::json::string ctx = "") const
    {
        ...
        Expression e = make_error(type_name<T>(), msg, ctx);
